...
if __name__ == '__main__':
    ...
    if not os.path.exists(SPLIT_DIR) or not os.listdir(SPLIT_DIR):
        print("[*] Thư mục dữ liệu chia sẵn không tồn tại. Đang chạy '3_tienxulyanh.py' để tiền xử lý và cân bằng tập Train...")
        import subprocess
        subprocess.run(["python", "3_tienxulyanh.py"], check=True)
